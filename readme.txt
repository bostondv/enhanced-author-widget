=== User Bio Widget ===
Tags: widget, author, bio, user bio, gravatar
Requires at least: 2.8
Tested up to: 3.2.1
Stable tag: 0.1

Display the "Biographical Info" and Gravatar of any author's user profile in your blog's sidebar.

== Description ==

This widget allows you to display the "Biographical Info" of any blog author's user profile in the sidebar. Subscribers are excluded for obvious reasons (Contributors, Authors, Editors, and Administrators are included).
...
1. Upload `ehanced-author-widget.php` to the `/wp-content/plugins/` directory.
